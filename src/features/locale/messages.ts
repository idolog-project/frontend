...
export const ko = {
  ...
  'home.filterMore': '{names} 외 {count}명',
  ...
  'review.title': '리뷰',
  'review.count': '리뷰 {count}개',
  'review.rating': '별점',
  'review.ratingValue': '{n}점',
  'review.placeholder': '이 촬영지는 어때나요?',
  'review.submit': '등록하기',
  'review.empty': '아직 리뷰가 없어요. 첫 리뷰를 남겨보세요.',
  'review.notWired': '리뷰 등록은 아직 준비 중입니다.',
  ...
  'plan.more': '더 자세히 설정',
  'plan.moreHint': '출발 시간, 희망 여행 시간, 반려동물, 인원',
  'plan.startTime': '출발 시간',
  'plan.hours': '희망 여행 시간 · {hours}시간',
...
export const en: Record<MessageKey, string> = {
  ...
  'review.ratingValue': '{n} out of 5',
  'review.placeholder': 'How was this filming location?',
  'review.submit': 'Post',
  'review.empty': 'No reviews yet. Be the first to leave one.',
  'review.notWired': 'Posting reviews is not connected yet.',
  ...
  'plan.moreHint': 'Start time, preferred length, pets, party size',
  'plan.startTime': 'Start time',
  'plan.hours': 'Preferred length · {hours} hr',
...
export const zh: Record<MessageKey, string> = {
  ...
  'home.filterMore': '{names} 等{count}人',
  'home.spotList': '拍摄地列表',
  ...
  'review.title': '评论',
  'review.count': '评论 {count}条',
  'review.rating': '评分',
  'review.ratingValue': '{n}分',
  'review.placeholder': '这个拍摄地怎么样？',
  'review.submit': '发布',
  'review.empty': '还没有评论，来写第一条吧。',
  'review.notWired': '评论发布功能尚未接入。',
  ...
  'plan.more': '更多设置',
  'plan.moreHint': '出发时间、期望时长、宠物、人数',
  'plan.startTime': '出发时间',
  'plan.hours': '期望时长 · {hours}小时',
  'plan.partySize': '出行人数',
  'plan.withPet': '带宠物同行',
  'plan.submit': '规划路线',
